...
-- TODO: knowing what delta is does not uniquely determine tok
-- Solution: So you need a way for the caller to specify tok. Add a proxy tok argument to it. Then you can use it with either asProxyTypeOf or ScopedTypeVariables.
